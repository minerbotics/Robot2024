...
public class AutoSpeakerScore extends SequentialCommandGroup{
    ...
    public AutoSpeakerScore(Swerve swerve, Swinger swinger, IntakeSubsystem intake, Shooter shooter){
        m_Swerve = swerve;
        m_Swinger = swinger;
        m_Intake = intake;
        m_Shooter = shooter;
        addCommands(
            new ManeuverOn(m_Swerve, GoalTypeConstants.SPEAKER).withTimeout(3),
