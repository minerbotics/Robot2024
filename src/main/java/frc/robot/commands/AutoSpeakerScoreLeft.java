...
public class AutoSpeakerScoreLeft extends SequentialCommandGroup{
    ...
    public AutoSpeakerScoreLeft(Swerve swerve, Swinger swinger, IntakeSubsystem intake, Shooter shooter){
        m_Swerve = swerve;
        m_Swinger = swinger;
        m_Intake = intake;
        m_Shooter = shooter;
